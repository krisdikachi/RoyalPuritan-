"""
Django settings for RoyalPuritan project.
...
CSRF_TRUSTED_ORIGINS = [ "https://royalpuritan-production.up.railway.app"]
...
WSGI_APPLICATION = 'RoyalPuritan.wsgi.application'
